...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['newExpenseType']) && isset($_POST['newBudgetAmount'])) {
...
<head>
    ...
    <style>
        ...
        .btns {
            ...
            top: calc(150px + 150px); /* Adjust top spacing based on title height and margin */
        ...
        .btns button {
            ...
            color:white;
            display: block; /* Ensure each button is displayed on a new line */
            transition: all 0.3s ease;
        }
        .btns button:hover{
...
<body>
    <div class="title">
        ...
        <div class="income">
            <h3>Income: <?php echo $income; ?></h3>
        </div>
        <div class="btns">
            <button onclick="window.location.href='dashboard.php';" style=" margin-top:80px;">Dashboard</button>
            <button  onclick="window.location.href='budget.php';" style="font-size: 25px; font-weight: 800;  ">Budget</button>
